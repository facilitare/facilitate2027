      ...
      <main style={{ minHeight: "100vh", background: "var(--bg)", display: "grid", placeItems: "center", padding: 24 }}>
        ...
        >
          ...
          <p style={{ fontSize: 13, color: "var(--text-muted)", marginTop: 8, lineHeight: 1.5 }}>
            The applications ranking table is available to panel leads only. You are signed in as <strong style={{ color: "var(--text)" }}>{evaluator.name}</strong> (assessor).
          </p>
    ...
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      >
        <a href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none", color: "inherit" }}>
          ...
          <span style={{ fontSize: 12, color: "var(--text-faint)", marginLeft: 6, borderLeft: "1px solid var(--border)", paddingLeft: 10 }}>
